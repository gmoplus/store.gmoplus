...
<div class="auth">{strip}
    <div class="cell">
        <div>
            ...
            <input class="w210" type="text" name="login[username]" maxlength="100" value="{$smarty.post.login.username}" />

            <div class="name">{$lang.password}</div>
            <input class="w210" type="password" name="login[password]" maxlength="100" />
    ...
    <div class="cell">
        ...
        <div>
            ...
            {if !$quick_types || ($quick_types && $quick_types|@count <= 1)}
            ...
            <input class="w210" type="text" name="register[email]" maxlength="100" value="{$smarty.post.register.email}"  />

            {if $quick_types && $quick_types|@count > 1}
                <div class="name">{$lang.account_type}</div>
                <select class="w120" name="register[type]">
