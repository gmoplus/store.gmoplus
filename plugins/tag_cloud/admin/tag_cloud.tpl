...
<div id="action_blocks">
    {if !isset($smarty.get.action)}
        ...
        <form method="post" onsubmit="return false;" id="search_form" action="">
            ...
            <tr>
                ...
                <td class="field">
                    ...
                    <a class="cancel" href="javascript:void(0)" onclick="show('search', '#action_blocks div');">{$lang.cancel}</a>
                </td>
            </tr>
        ...
        {include file='blocks'|cat:$smarty.const.RL_DS|cat:'m_block_start.tpl' block_caption=$lang.tc_import}
        ...
        <form method="post" onsubmit="return false;" id="import_form" action="">
            ...
            <tr>
                ...
                <td class="field">
                    ...
                    <a class="cancel" href="javascript:void(0)" onclick="show('import', '#action_blocks div');">{$lang.cancel}</a>
                </td>
            </tr>
        ...
        <tr>
            ...
            <td class="field">
                ...
                {foreach from=$allLangs item='language' name='langF'}
                    ...
                    {assign var='dCode' value='h1_'|cat:$language.Code}
                    {fckEditor name='h1_'|cat:$language.Code width='100%' height='140' value=$sPost.$dCode}
