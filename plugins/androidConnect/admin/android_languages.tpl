	...
	<div id="lang_add_phrase" class="hide">
		...
		<form action="" method="post" onsubmit="return false;">
			...
			<tr>
				<td></td>
				<td class="field">
					<input id="add_phrase_submit" onclick="$(this).val('{$lang.loading}');return rlCheck( Array( Array( 'phrase_key', '{$lang.incorrect_phrase_key}', '>^2' ) , Array( 'phrase_side', '{$lang.language_incorrect_date_format}' ) ), 'js_addPhrase' );" type="submit" value="{$lang.add}" />
