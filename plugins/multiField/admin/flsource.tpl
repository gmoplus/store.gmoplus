...
{elseif $topdata}
    ...
    <span id="cats_nav" {if $sPost.show_on_all}class="hide"{/if}>
        <span onclick="$('div.td_div input').prop('checked', true);" class="green_10" style="cursor:pointer">{$lang.check_all}</span>
        <span class="divider"> | </span>
        <span onclick="$('div.td_div input').prop('checked', false);" class="green_10" style="cursor:pointer">{$lang.uncheck_all}</span>
    </span>
