<fieldset class="light">
    ...
    <div id="cats">
                ...
                {foreach from=$sections item='section'}
                    <fieldset class="light">
                        ...
                        {if $section && $section.Categories && $section.Categories|@count > 5}
                            <div class="grey_area">
                                <span>
                                    <span onclick="$('#section_{$section.ID} input').prop('checked', true);" class="green_10">{$lang.check_all}</span>
                                    <span class="divider"> | </span>
                                    <span onclick="$('#section_{$section.ID} input').prop('checked', false);" class="green_10">{$lang.uncheck_all}</span>
                                </span>
                            </div>
                        {/if}
                    </fieldset>
        ...
        <div class="grey_area">
            ...
            {if $cKey == 'blocks'}
                <div id="box_sticky_type_categories_only" class="field_description hide" style="margin: 5px 0 0 0;">{$lang.box_sticky_type_categories_only}</div>
            {/if}
        </div>
