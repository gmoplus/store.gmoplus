...
<link href="{$rlTplBase}css/jquery.ui.css?rev={$config.static_files_revision}" type="text/css" rel="stylesheet" />
<link href="{$rlTplBase}css/common.css?rev={$config.static_files_revision}" type="text/css" rel="stylesheet" />

<link href="{$smarty.const.RL_LIBS_URL}jquery/colorpicker/css/colorpicker.css?rev={$config.static_files_revision}" type="text/css" rel="stylesheet" />
{if isset($smarty.get.key) || isset($smarty.get.form)}
    <link href="{$rlTplBase}css/builder.css?rev={$config.static_files_revision}" type="text/css" rel="stylesheet" />
{/if}
<link type="image/x-icon" rel="shortcut icon" href="{$rlTplBase}img/favicon.ico?rev={$config.static_files_revision}" />

{if (($tpl_settings.category_menu_listing_type || $tpl_settings.listing_type_form_icon) && $cKey == 'listing_types')
    || ($tpl_settings.category_menu && $cKey == 'categories')}
    <link href="{$rlTplBase}css/icons-manager.css?rev={$config.static_files_revision}" type="text/css" rel="stylesheet" />
{/if}

<script type="text/javascript" src="{$smarty.const.RL_LIBS_URL}jquery/jquery.js?rev={$config.static_files_revision}"></script>
<script type="text/javascript" src="{$smarty.const.RL_LIBS_URL}jquery/jquery.ui.js?rev={$config.static_files_revision}"></script>
<script type="text/javascript" src="{$smarty.const.RL_LIBS_URL}jquery/datePicker/i18n/ui.datepicker-{$smarty.const.RL_LANG_CODE|lower}.js?rev={$config.static_files_revision}"></script>
<script type="text/javascript" src="{$smarty.const.RL_LIBS_URL}jquery/numeric.js?rev={$config.static_files_revision}"></script>
<script type="text/javascript" src="{$smarty.const.RL_LIBS_URL}jquery/cookie.js?rev={$config.static_files_revision}"></script>
<script type="text/javascript" src="{$rlBase}js/lib.js?rev={$config.static_files_revision}"></script>
...
<script type="text/javascript" src="{$rlBase}js/ext/RowExpander.js?rev={$config.static_files_revision}"></script>
<script type="text/javascript" src="{$rlBase}js/ext/rlGrid.js?rev={$config.static_files_revision}"></script>
<!-- EXT js load end -->
