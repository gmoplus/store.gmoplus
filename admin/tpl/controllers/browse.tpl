...
<div class="nav_bar">
    ...
    {if $aRights.categories.add}
        <a href="{$rlBase}index.php?controller=categories&amp;action=add&amp;parent_id={$category.ID}" class="button_bar"><span class="left"></span><span class="center-add">{$lang.add_category}</span><span class="right"></span></a>
    {/if}
...
{if $category.ID}
    ...
    <div id="nav_bar">
        ...
        {if $aRights.listings.add}
            <a href="{$rlBase}index.php?controller=listings&amp;action=add&amp;category={$category.ID}" class="button_bar"><span class="left"></span><span class="center-add">{$lang.add_listing}</span><span class="right"></span></a>
        {/if}
    </div>
{/if}
<!-- navigation bar end -->
