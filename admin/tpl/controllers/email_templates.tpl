...
<div id="nav_bar">
    ...
    {if !$smarty.get.action}<a href="{$rlBaseC}action=add" class="button_bar"><span class="left"></span><span class="center-add">{$lang.add_template}</span><span class="right"></span></a>{/if}
            ...
            <td class="field">
                ...
                {foreach from=$allLangs item='language' name='langF'}
                    ...
                    <div style="padding: 5px 0 0 0;">
                        ...
                        <textarea id="body_{$language.Code}" {if $language.Direction == 'rtl'}dir="rtl"{/if} lang="{$language.Code}" rows="9" cols="40" name="description[{$language.Code}]" style="height: 200px;">{if $sPost.type == 'plain'}{$sPost.description[$language.Code]}{/if}</textarea>
                    </div>
                    {if $allLangs|@count > 1}
                        </div>
                    {/if}
