...
{if $aRights.$cKey.add}
    ...
    <div id="nav_bar">
        <a href="javascript:void(0)" onclick="show('new_item');$('#edit_item').slideUp('fast');" class="button_bar"><span class="left"></span><span class="center-add">{$lang.add_amenity}</span><span class="right"></span></a>
    </div>
{/if}
<!-- navigation bar end -->
