...
<div id="nav_bar">
    ...
    {if $aRights.$cKey.add}
        <a href="{$rlBaseC}action=add" class="button_bar"><span class="left"></span><span class="center-add">{$lang.add_membership_plan}</span><span class="right"></span></a>
    {/if}
...
{if $smarty.get.action}
    <script type="text/javascript" src="{$smarty.const.RL_LIBS_URL}jquery/colorpicker/js/colorpicker.js?rev={$config.static_files_revision}"></script>
                ...
                <td class="field">
                    <fieldset class="light">
                        ...
                        <div id="services_settings" style="padding: 0 10px 10px 10px;">
                            ...
                            <div class="grey_area" style="margin: 8px 0 0;">
                                <span onclick="$('#services_settings input').prop('checked', true); checkAccountTypes(true);" class="green_10">{$lang.check_all}</span>
                                <span class="divider"> | </span>
                                <span onclick="$('#services_settings input').prop('checked', false); checkAccountTypes(false);" class="green_10">{$lang.uncheck_all}</span>
                            </div>
                        </div>
                    </fieldset>
                </td>
