                            ...
                            <a href="{$rlBase}" title="{$config.site_name}">
                                <img alt="{$config.site_name}"
                                    src="{strip}
                                        {$rlTplBase}
                                        img/logo
                                        {if $config.general_simple_color != 'green'}_{$config.general_simple_color}{/if}
                                        .png{/strip}?rev={$config.static_files_revision}"
                                    srcset="{strip}
                                        {$rlTplBase}
                                        img/@2x/logo
                                        {if $config.general_simple_color != 'green'}_{$config.general_simple_color}{/if}
                                        .png{/strip}?rev={$config.static_files_revision} 2x" />
                            </a>
                        </div>
