...
<div id="wrapper" class="flex-fill w-100">
    <section id="main_container">
        ...
        {if $pageInfo.Key != 'search_on_map' && $config.header_banner_space}
            <div class="header-banner-cont w-100 h-100 mx-auto {if !$bread_crumbs_exists}pt-3 pt-md-5{else}pb-5{/if} d-flex justify-content-center">
        ...
        <div class="inside-container point1 clearfix pt-4 pt-md-5 mt-2 mt-md-0{if $pageInfo.Key != 'home'} pb-5{/if}">
